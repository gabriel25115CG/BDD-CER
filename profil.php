...
<div class="container mt-5">
    <h1 class="mb-4">Bonjour <?php echo $_SESSION['user']['prenom']; ?>, Cliquez sur le bouton pour voir les informations de votre profil !</h1>
    <button id="showInfoBtn" class="btn btn-primary mb-4">Afficher les informations</button>
    <form id="userInfoForm" style="display: none;">
        <div class="form-group mb-4">
            <label for="prenom">Prénom</label>
            <input type="text" class="form-control" id="prenom" value="<?php echo $_SESSION['user']['prenom']; ?>" readonly>
        </div>
        <div class="form-group mb-4">
            <label for="nom">Nom</label>
            <input type="text" class="form-control" id="nom" value="<?php echo $_SESSION['user']['nom']; ?>" readonly>
        </div>
        <div class="form-group mb-4">
            <label for="email">Email</label>
            <input type="email" class="form-control" id="email" value="<?php echo $_SESSION['user']['email']; ?>" readonly>
        </div>
